...
<br><br> An upgraded version (`20201002_2`) of the picking models is also available.
These models were trained using 2x (for P phase) and 3x (for P phase) the number of shifted versions of the seismic records originally used in Soto and Schurr (2021).
