...
An easy and straightforward way to install DPP is to directly clone the public repository:

    git clone https://github.com/hsotoparada/DeepPhasePick.git
    cd DeepPhasePick
...
`version_pick_P = version_pick_S = "20201002_2"; ntrials_P = ntrials_S = 50`: best-performing picking models,
